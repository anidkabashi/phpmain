<?php 
  ...
  $users_data = $selectProduct->fetchAll();
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
          <?php foreach ($products_data as $user_data) { ?>
        ...
        <table>
          ...
          <tbody>
            <tr> 
              ...
              <td> <?= "<a href='delete.php?id=$user[id]'> Delete</a>| <a href='product.php?id=$user[id]'> Update </a>"?></td>
            </tr>
