<?php 
	...
	if(isset($_POST['update']))
	{
		...
		if(empty($title) || empty($description) || empty($) || empty($quantity) || empty($price))
		{
		...
		{
			$sql= "UPDATE users title=:title, description=:description, quantity=:quantity, price=:price WHERE id=:id";
